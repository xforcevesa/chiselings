...
```sh
git clone git@github.com:xforcevesa/nscscc-training-exercise-1.git
cd nscscc-training-exercise-1
```
...
#### Commit your changes
```sh
git commit -m 'Starting nscscc-training-exercise-1'
...
```sh
mill nscscc-training-exercise-1.test
```
